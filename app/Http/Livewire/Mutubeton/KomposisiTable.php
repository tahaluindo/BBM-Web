...
final class KomposisiTable extends PowerGridComponent
{
    use ActionButton;
    ...
    *
    * @return  \Illuminate\Database\Eloquent\Builder<\App\Models\Komposisi>|null
    */
    public function datasource(): ?Builder
    {
        return Komposisi::join('mutubetons','komposisis.mutubeton_id','mutubetons.id')
    ...
    */
    public function addColumns(): ?PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn('updated_at_formatted', function(Komposisi $model) { 
...
;
    ...
    */
     ...
     /**
     * PowerGrid Komposisi Action Buttons.
     *
    ...
    */
     ...
     /**
     * PowerGrid Komposisi Action Rules.
     *
    ...
    public function actionRules(): array
    {
       return [
           ...
           //Hide button edit for ID 1
            Rule::button('edit')
                ->when(fn($komposisi) => $komposisi->id === 1)
                ->hide(),
        ];
    }
    */
    ...
    */
    ...
    {
       try {
           $updated = Komposisi::query()->findOrFail($data['id'])
                ->update([
